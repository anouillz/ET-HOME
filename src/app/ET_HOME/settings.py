...
SECRET_KEY = 'django-insecure-cs=)@^wxvo*9!fb5t_xlppl@8&(hmr!z3s+na*l@lnktm&i-lp'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ET_HOME.context_processors.navbar_links'
            ],
        },
    },
]

WSGI_APPLICATION = 'ET_HOME.wsgi.application'
